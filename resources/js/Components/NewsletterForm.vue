...
<template>
  <div class="relative isolate overflow-hidden bg-gray-900 py-8 sm:py-24 lg:py-32 max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-7xl px-2 lg:px-8">
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
        <div class="max-w-xl lg:max-w-lg">
          ...
          <p class="mt-4 text-lg leading-8 text-gray-300">Join our Movie Guru community today and discover hidden cinematic gems, reviews, and trends every week. </p>
          <form @submit.prevent="subscribe" class="mt-6 flex max-w-md gap-x-4">
        ...
        <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
          <div class="flex flex-col items-start">
            ...
            <dd class="mt-2 leading-7 text-gray-400">Discover cinematic wonders with our weekly movie articles. From reviews to behind-the-scenes, get your movie fix here.
            </dd>
          </div>
          <div class="flex flex-col items-start">
            <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
            ...
            <dd class="mt-2 leading-7 text-gray-400">We value your time and privacy! Expect only valuable content from Movie Guru's newsletter, never spam.
            </dd>
          </div>
        </dl>
      </div>
