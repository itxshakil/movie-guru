                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="padding:20px;">
                                        ...
                                        <p style="margin:0 0 12px;font-size:13px;color:#86868b;">{{( $hiddenGem->year}} @if(($hiddenGem->imdb_rating && $hiddenGem->imdb_rating !== 'N/A' && (int) $hiddenGem->imdb_rating !== )
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="padding:16px;">
                                        ...
                                        <p style="margin:0 0 10px;font-size:12px;color:#86868b;">
                                            {{( $movie->year}}
                                            @if(($movie->imdb_rating && $movie->imdb_rating !== 'N/A' && (int) $movie->imdb_rating !== )
                                                · ⭐ {{( $movie->imdb_rating}}
                                            @endif
                                            @if(($movie->genr)
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="padding:16px;">
                                        ...
                                        <p style="margin:0 0 10px;font-size:12px;color:#86868b;">{{( $recommendedMovie->year}}@if(($recommendedMovie->imdb_rating && $recommendedMovie->imdb_rating !== 'N/A' && (int) $recommendedMovie->imdb_rating !== )
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="padding:16px;">
                                        ...
                                        <p style="margin:0 0 10px;font-size:12px;color:#86868b;">{{( $trendingMovie->year}}@if(($trendingMovie->imdb_rating && $trendingMovie->imdb_rating !== 'N/A' && (int) $trendingMovie->imdb_rating !== )
