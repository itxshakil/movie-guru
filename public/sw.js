...
const APP_CACHE = 'v-3';
const SEARCH_CACHE = 'search-cache-v-3';
const INFO_CACHE = 'info-cache-v-3';
const DYNAMIC_CACHE = 'dynamic-cache-v-3';
const POSTER_CACHE = 'poster-cache-v-3';
const STATIC_ASSETS = [
    '/app.webmanifest',
