...
const APP_CACHE = 'v-0.8.2';
const SEARCH_CACHE = 'search-cache-v-0.8.2';
const INFO_CACHE = 'info-cache-v-0.8.2';
const DYNAMIC_CACHE = 'dynamic-cache-v-0.8.2';
const POSTER_CACHE = 'poster-cache-v-0.8.2';
const STATIC_ASSETS = [
    '/app.webmanifest',
